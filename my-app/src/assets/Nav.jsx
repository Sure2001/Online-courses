        ...
        <Container>
          ...
          >
            <Nav className="me-auto">
              ...
              >
                <div className="dropdown-grid">
                  ...
                  <NavDropdown.Item as={Link} to="/softwaretesting">
                  ...
                  <NavDropdown.Item as={Link} to="/digitalmarketing">
            ...
            <div className="nav-button d-flex align-items-center">
              <Link
                to="/card"
                className="card-button position-relative d-flex align-items-center gap-1"
              >
              ...
              <Link to="/signin" className="btn main-1">
                Sign in
              </Link>
              <Link to="/signup" className="btn main-2">
                Sign up
              </Link>
            </div>
          </Navbar.Collapse>
